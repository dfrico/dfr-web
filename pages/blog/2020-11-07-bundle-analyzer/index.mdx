...
For example, a simplified version of my next config (<Link href="/blog/2020-11-05-mdx-intro"><a>using MDX</a></Link>), would look like:
...
<figure>
  <img src={BundleImg} alt="application bundle treemap" />
  <figcaption>
