...
Now, as I mentioned in a <Link href="/blog/2020-11-05-mdx-intro"><a>post before</a></Link>, I setted up this blog using NextJS, MDX, and GitHub + Vercel hooks. This means that I could write this entry (.mdx file), add any required photos, push it using [Working Copy](https://workingcopyapp.com), and Vercel would take my commit and deploy it automatically.
