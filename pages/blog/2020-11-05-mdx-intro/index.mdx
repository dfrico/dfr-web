...
There are several reasons why I'm using Next, mainly because its blazing performance. It uses server side rendering and crazy optimization to bundle your web application and serve a light website to you. I may write more about Next in the future, let's see.
...
Apart from the base configuration, there are several key things here:
...
This file that lives in the `utils` folder of my repo, has a (relatively) simple code:
